    ...
    <div className="p-6 sm:p-8 bg-black shadow-lg rounded-lg max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div className="order-2 md:order-1 grid grid-cols-3 text-[#f9e7b8] items-center mt-8 md:mt-0">
          ...
          <div>
            <p className="text-xl font-bold sm:text-2xl">{friends || 0}</p>
...
<button
  ...
  className="relative hover:cursor-pointer w-12 h-12 rounded-full border border-[#f9e7b8] text-[#f9e7b8] flex items-center justify-center hover:bg-[#f9e7b8] hover:text-black transition shadow-md"
