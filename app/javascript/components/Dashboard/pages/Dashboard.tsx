...
import RecentGame from "../comps/RecentGame";
import TotalGoals from "../comps/TotalGoals";
import TotalMatches from "../comps/TotalMatches";
import TotalWC from "../comps/TotalWC";
